...
class ss_acf_integrate {
	...
	public function __construct( $name = false, $version = false ) {
		...
		$this->acf_dir = plugin_dir_path( dirname( __FILE__ ) ) .'inc/acf/';
		$this->acf_url = plugin_dir_url( dirname( __FILE__ ) ) .'inc/acf/';
		$this->acf_json = plugin_dir_path( dirname( __FILE__ ) ) .'inc/acf_json/';
