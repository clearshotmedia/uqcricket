...
if ( ! function_exists( 'uqcricket_pagination' ) ) {
	/**
	 ...
	 */
	function uqcricket_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'uqcricket' ),
				'next_text'          => __( '&raquo;', 'uqcricket' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'uqcricket' ),
			)
		);
